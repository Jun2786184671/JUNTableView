...
Pod::Spec.new do |s|
  s.name             = 'JUNTableView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JUNTableView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jun Ma/JUNTableView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jun Ma' => 'maxinchun5@gmail.com' }
  s.source           = { :git => 'https://github.com/Jun Ma/JUNTableView.git', :tag => s.version.to_s }
